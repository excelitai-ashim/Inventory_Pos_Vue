       ...
       <div class=" container">
         ...
         <div class="card col-lg-8 card_center">
          <div class="card-header">
            ...
            Category Update 
            <router-link to="/viewAllCategory" class="btn btn-sm btn-info" id="add_new"> All Category</router-link>
          </div>
          <div class="card-body">
               ...
               <button type="submit" class="btn btn-success card_center">Update</button>
        ...
        methods:{ 	
        	...
        	categoryUpdate(){
			    ...
			    for(let i in this.form){
			      ...
			      axios.post('/api/category/'+id+'/update/',formData)
