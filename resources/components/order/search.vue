       ...
       <div class="row container">
         <div class="card col-lg-12">
          <div class="card-header">
            ...
            Search Orders 
            <router-link  :to="{name:'orders'}" class="btn btn-sm btn-info" id="add_new"> Today Order</router-link>
          </div>
          <div class="row">
          	<div class="col-lg-6">
    ...
    export default {
        ...
        methods:{ 	
        	searchDate(){
        		...
        		axios.post('/api/search/date',date)
        		.then(({data}) => {
                 this.orders = data;
               })
        	...
        	searchMonth(){
				let month={month:this.month}
        		axios.post('/api/search/month',month)
        		.then(() => {
