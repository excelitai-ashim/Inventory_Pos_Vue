	              ...
	              <div class="form-row">
	               <div class="col-md-6">
	                <div class="form-label-group">
	                  ...
	                  <small class="text-danger" v-if="Object.keys(errors) && errors.name">{{ errors.name[0] }}</small>
	               ...
	               <div class="col-md-6">
	                <div class="form-label-group">
	                  ...
	                  <small class="text-danger" v-if="Object.keys(errors) && errors.email">{{ errors.email[0] }}</small>
	              ...
	              <div class="form-row">
	               ...
	               <div class="col-md-6">
	                <div class="form-label-group">
	                  ...
	                  <small class="text-danger" v-if="Object.keys(errors) && errors.salary">{{ errors.salary[0] }}</small>
	                </div>
	               </div>
	             </div>
	          </div>
